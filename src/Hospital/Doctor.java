...
public class Doctor extends Person implements DisplayInformation{
    ...
    public Doctor(String id, String name, int age, Gender gender, String phoneNumber, String specialty, Ward ward, int dailyCapacity, LocalTime shiftStart, LocalTime shiftEnd){
